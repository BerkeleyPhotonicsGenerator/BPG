...
export BAG_CONFIG_PATH=${BAG_WORK_DIR}/workspace_setup/bag_config.yaml
export BAG_FRAMEWORK=${BAG_WORK_DIR}/BAG_Framework
export BAG_TECH_CONFIG_DIR=${BAG_WORK_DIR}/BPG/examples/tech/BAG_tech_files
export BAG_TEMP_DIR=${BAG_WORK_DIR}/tmp
export PYTHONPATH="$(cat startup.txt)"

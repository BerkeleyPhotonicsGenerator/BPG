"""
This module contains classes for each type of shape in the content list. These classes define static methods that
will convert a content_list representation to a lumerical lsf representation
"""
import gdspy
import numpy as np
import sys

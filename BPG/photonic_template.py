...
class PhotonicTemplateDB(TemplateDB):
    ...
    def to_lumerical(self,
        ...
        3) For each element in the flat content list, convert it into lsf code and append to running export file
            3a) lsf code is generated by sending properties and tech info to the lsf_export static method
                in each shape class
            3b) lsf code is appended to the running file with LumericalDesignGenerator
